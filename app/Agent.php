...
class Agent extends Model
{
    ...
    protected $visible = array('id', 'created_at', 'img_cni','img_cni_back','puce_number','puce_name','point_de_vente', 'reference', 'taux_commission', 'ville', 'pays', 'id_creator', 'id_user');
